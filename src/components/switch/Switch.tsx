...
const Switch = () => {
    ...
    return <div className="h-10 overflow-hidden w-[6rem] p-2 relative border-[#ffffff34] rounded-full border bg-[#00000027]">
        <div style={active ? { marginLeft: "3.3rem", } : { marginRight: "1rem" }} className="w-6 h-6  border-[#ffffff46] border-2 duration-300 cursor-pointer  rounded-full bg-purple-500 absolute z-20">
        </div>
