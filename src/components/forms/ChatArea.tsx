...
const RecordRippleButton = createRipples({
  color: "#ffffff0b",
  during: 600,
  className: "rounded-full record-btn   w-12 h-12"
})
...
const ChatArea: React.FC<Props> = ({ listening, onStartRecording, onStopRecording }) => {
  ...
  return <div className="w-full items-center gap-3 flex">
    ...
    <RecordRippleButton>
      ...
      }} type="button" className="border  record-btn rounded-full outline-none flex items-center justify-center text-2xl text-[#ffffff89] bg-[#ffffff0b]  outline border-[#ffffff25] w-full h-full  ">
